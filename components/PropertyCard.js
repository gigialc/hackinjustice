      ...
      <div className="property-info">
        ...
        {property.hospital_proximity && property.hospital_proximity.length > 0 && (
          <div className="hospital-proximity">
            <span>Near: {property.hospital_proximity[0].hospital_name} ({property.hospital_proximity[0].distance_in_miles} miles)</span>
          </div>
        )}
        
        <Link href={`/properties/${property.id}`} className="view-details">
          View Details
        </Link>
      </div>
    </div>
